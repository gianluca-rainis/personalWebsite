...
function buildAsciiPanel(label) {
    ...
    switch (label) {
        case "picture":
            return `<style>@media(max-width: 366px){.asciiPanel{font-size: 3px !important; line-height: 3px !important}}</style><p class="asciiPanel" style="font-size:6px; line-height:6px; margin:0; text-align:center;">#*-+#%%#%@@****%@%%##*#*##*#**##%%%%%%@@@@@@@@@@@@@@%%%%%%%%%*++++::-****%%+*++*+%#*@@@%@%###%%%%%%%
++-:-=#=%%%++++%%#@%#+#+#*#*####%%%%%%%%@@@%@@@@@@%@@@@%%##%%++++=::=****#%=====*%*-=#%@@%%####%%%%%
+-=++=#-#*====+##+%%*%%*#+#+#*%%##%#%%%%%%@%%%%@@@####%%%%%#**+++-::=+++*##=---=*%*-+%%##%%@%###%%%%
@#+*#%#=###=--=*+=##+#@@@#++%##%*#%%%%%%%%@%%%%@@@@%%%%%###%%%%%%%@%*++++#*-----#%+-####%%%@%@%###%%
%%%@@%#--=+=::=+::++=*%@%###%##+##%###%%%%%%%%%@@@@%##%%%@@@%%%%%@%%#=+%*#*-----#%==*=*%#%%@@@%@%#%%
